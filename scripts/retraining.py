...
def main():
    ...
    parser.add_argument(
        "--timeseries",
        type=str,
        default="results/data/timeseries.tsv",
        help="Path to the timeseries of the bacterial genera.",
    )
    parser.add_argument(
        "--taxa",
        type=str,
        default="results/data/taxa.tsv",
        help="Path to the list of general taxa.",
    )
    parser.add_argument(
        "--metadata",
        type=str,
        default="results/data/metadata.tsv",
        help="Path to the metadata belonging to the timeseries.",
    )
    parser.add_argument(
        "--tcn-path",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Path to the saved scaler pickle file (unused by raw prediction).",
    )
    parser.add_argument(
        "--prediction-interval",
        type=str,
        default="results/tables/prediction_interval.tsv",
        help="Path to save the model's prediction interval.",
    )
    parser.add_argument(
        "--predictions",
        type=str,
        default=None,
        help="Optional NPZ file containing pred_train, pred_val, pred_test arrays",
    )
    parser.add_argument(
        "--anomalies-output",
        type=str,
        default="results/tables/prediction_interval_anomalies.tsv",
        help="Path to save the model's interval anomalies.",
    )
    parser.add_argument(
        "--plot-results",
        type=str,
        default="results/tables/plot_taxa_anomalies.html",
        help="Path to plot of results.",
    )
    ...
    plot_taxa_dropdown(
        args.timeseries,
        "results/intermediate/dic_TargTax.pkl",
        anomalies,
        args.prediction_interval,
        args.predictions,
        args.plot_results,
