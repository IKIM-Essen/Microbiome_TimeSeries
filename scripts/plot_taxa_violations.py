...
def plot_taxa_dropdown(complete_csv, dic_taxa_path, violations_tsv, prediction_interval_tsv, predictions_npz, split_sizes_path, output_html="results/tables/plot_taxa_violations.html"):
...
if __name__ == "__main__":
    ...
    plot_taxa_dropdown(args.complete, args.dic_taxa, args.violations, args.prediction_interval, args.predictions, args.split_sizes, args.output)
