...
def main():
    ...
    parser.add_argument("--anomalies", type=str, default="results/tables/prediction_interval_anomalies.tsv", help="TSV of anomalies")
    ...
    parser.add_argument("--output", type=str, default="results/figures/plot_taxa_anomalies.html", help="Output HTML path")
    args = parser.parse_args()
    plot_taxa_dropdown(args.complete, args.dic_taxa, args.anomalies, args.prediction_interval, args.predictions, args.output)
