...
def plot_data(totalValues, trained, predicted, species, n_steps, eval_dictionary, y_hat):
...
present_orig, present_predicted = get_only_predicted_bacteria("bacteria_list_final4.tsv", bacteria, Yretrans, predictedY)
...
ml_plots.prediction_plot(plotpath+"prediction_plots/", interpolate_df, trainYRetrans, predictValYRetrans, predictedY, species, y_hat, error_hat, n_steps, eval_dict, outlier)
...
general_functions.get_metrics(TrainRetrans,trainYRetrans,ValYRetrans,predictValYRetrans,present_orig,array_list_small,plotpath+"errormetrics.csv")
